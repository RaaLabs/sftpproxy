// http -> sftp proxy initially needed to solve http transfer
// over high latency satellite links.
// NB: Since this package is intended for use in private networks
// verification of the peer key is turned off to avoid logic for
// distributing/gathering of keys. This might be implemented in
// the future.
package main
...
// server holds the basic types needed for service
type server struct {
...
// newServer will return a *server
...
// newSSHConfig will return either a key or username/password
// config based on the value of sftpAuth
